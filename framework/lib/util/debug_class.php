...
class Debug
{
    ...
    function display()
    {
        If($this->dbg_Enabled){
            ...
            $this->PrintCollection("SQL&nbsp;Info", Core::getSqlLog(),$this->DivSet[6],"");
            echo "</Table>"; 
        } 
    }
    ...
    function etime($tt)
    {
        ...
        return sprintf('%0.5f',Core::getLogger()->getExecutionTime()).'S';//$time." ms";
    }
    function ememory($tt)
    {
        //$memory_end = memory_get_usage();
        //$memory = ($memory_end - $tt).'Byte;';
        return number_format(Core::getLogger()->getMemoryUsage()/1024).'KB';
    }
}
?>