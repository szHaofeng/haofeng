...
class Paging{
    ...
    private  $page;          //当前的页数
    public   $pagename = 'page';  //可选："页"的名字 默认为"p"
    ...
    public function  __construct($data=array())
    {
        ...
        $this->pagename=!empty($data["pagename"])?$data["pagename"]:"page";
    ...
    private function _get_link($page,$text)
    {
        ...
        if($this->ajax){
         ...
         return "<a href='javascript:;' onclick=\"GoPage($page,'".$this->pagename."');\">$text</a> "; 
    ...
    private function show_1(){
        ...
        if($this->ajax){
            ...
            $return.= "&nbsp;&nbsp;&nbsp;&nbsp;共&nbsp;{$this->totalpage} 页&nbsp;&nbsp;&nbsp;&nbsp;跳到第 <input id='page_input_".$rand."' style='width:24px;text-align:center'  value='".$this->page."' /> 页 <a href='javascript:;' onclick='GoPage(document.getElementById(\"page_input_".$rand."\").value,"."\"".$this->pagename."\");' >确定</a>";
    ...
    public function show($num=1){
        $block=$this->RegisterClientScriptBlock();
        switch ($num){
        case "2":
            return $this->show_2().$block;
            break;
        case "3":
            return $this->show_3().$block;
            break;
        case "4":
            return $this->show_4().$block;
            break;
        case "5":
            return $this->show_5().$block;
            break;
        default :
            return $this->show_1().$block;
            break;
        }
    }
    ...
    private function RegisterClientScriptBlock() {
        $script="<input type='hidden' name='".$this->pagename."' id='".$this->pagename."' value=".$this->page."> ";
        $script.="<script type=\"text/javascript\">";
        $script.="function GoPage(page,pagename) {";
        $script.="$(\"#\"+pagename).val(page); ";
